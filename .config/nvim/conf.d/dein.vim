...
if dein#load_state(g:user_home_cache_dir . "/dein")
  call dein#begin(g:user_home_cache_dir . "/dein")
    ...
    " call dein#add('folke/todo-comments.nvim') " (This plugin has compatibility issue with nvim-treesitter-context (it seems))
  call dein#end()
...
autocmd BufNewFile,BufRead *.sh setf bash | call ddc#custom#patch_filetype(['bash'], 'sources', ['nvim-lsp', 'file', 'around'])
